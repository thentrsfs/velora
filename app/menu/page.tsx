					...
					<div className='lg:max-w-150 '>
						...
						<div className='menu-text opacity-0 translate-y-10'>
							...
							<div className='mt-10 flex gap-4'>
								<Link
									href='/#contact'
									className='rounded-full border border-primary text-text py-2 px-5 text-sm lg:text-base hover:bg-primary hover:text-bg transition-all duration-300 cursor-pointer'>
									Reserve table
								</Link>
							</div>
						</div>
