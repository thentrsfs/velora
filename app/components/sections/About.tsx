...
const About = () => {
	return (
		<section className='lg:h-dvh h-full grid lg:grid-cols-2 items-center px-6 lg:max-w-7xl mx-auto relative'>
			<div className='relative lg:h-160 overflow-hidden group rounded-4xl'>
				<Image
